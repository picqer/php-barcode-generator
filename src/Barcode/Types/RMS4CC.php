...
class RMS4CC extends BarcodeTypeAbstract implements BarcodeTypeInterface
{
     ...
     * @param bool   $kix  if true prints the KIX variation (doesn't use the start and end symbols, and the checksum)
     *                     - in this case the house number must be sufficed with an X and placed at the end of the code
     *
     * @return array barcode representation
     */
    protected function barcode_rms4cc(string $code, bool $kix = false): array
    {
        $notkix = !$kix;
        // bar mode
        // 1 = pos 1, length 2
