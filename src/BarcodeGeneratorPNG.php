        ...
        foreach ($barcodeData->getBars() as $bar) {
            ...
            if ($bar->isBar() && $barWidth > 0) {
                ...
                if ($this->useImagick && isset($imagickBarsShape)) {
                    $imagickBarsShape->rectangle($positionHorizontal, $y, ($positionHorizontal + $barWidth) - 1, ($y + $barHeight) - 1);
                } else {
                    imagefilledrectangle($image, $positionHorizontal, $y, ($positionHorizontal + $barWidth) - 1, ($y + $barHeight) - 1, $gdForegroundColor);
                }
            }
